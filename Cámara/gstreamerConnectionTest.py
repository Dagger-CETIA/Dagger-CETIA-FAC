...
#cap = cv2.VideoCapture('"c:\gstreamer\1.0\mingw_x86\bin\gst-launch-1.0 -v udpsrc port=9000 calps="application/x-rtp, media=(string)video, clock-rate=(int)90000, encoding-name=(string)H264" ! rtph264depay ! avdec_h264 ! videoconvert ! autovideosink sync=f"',cv2.CAP_GSTREAMER)
